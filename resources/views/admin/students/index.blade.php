...
<div class="page-header flex items-center justify-between">
    ...
    <div class="flex gap-2">
        <button type="button" onclick="openModal('modal-import-student')" class="btn-secondary flex items-center gap-2">
        ...
        <button type="button" onclick="openModal('modal-create-student')" class="btn-primary flex items-center gap-2">
